...
export const metadata: Metadata = {
  ...
  description: "ASC's full lineup: 3D SPI, AOI, conformal coating, digital video, 3D metrology, and jetting valves. 12 inspection systems for electronics manufacturing.",
