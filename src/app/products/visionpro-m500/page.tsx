          ...
          <div className="relative container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div className="relative">
                <div className="relative overflow-hidden rounded-2xl border border-accent-purple/30 bg-dark-bg aspect-square">
                  ...
                  <div className="relative z-10 h-full flex items-center justify-center p-12">
                    <Image src="/images/products/visionpro-m500.png" alt="VisionPro M500 Advanced Benchtop SPI" width={300} height={340} className="object-contain max-h-full w-auto rounded-lg" />
                  </div>
