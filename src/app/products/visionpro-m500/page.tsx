...
export const metadata: Metadata = {
  ...
  title: "VisionPro M500 | Benchtop 3D SPI",
  description: "Benchtop 3D SPI with 0.48um Z-resolution, 6.8um lateral resolution, and a larger FOV sensor. Real-time SPC charts for demanding paste measurement.",
...
const datasheet = documentForProduct("visionpro-m500");
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div className="relative">
                <div className="relative overflow-hidden rounded-2xl border border-accent-purple/30 bg-dark-bg mx-auto w-fit">
                  ...
                  <div className="absolute top-2 left-2 w-7 h-7 border-t-2 border-l-2 border-accent-purple/60" />
                  <div className="absolute top-2 right-2 w-7 h-7 border-t-2 border-r-2 border-accent-purple/60" />
                  <div className="absolute bottom-2 left-2 w-7 h-7 border-b-2 border-l-2 border-accent-purple/30" />
                  <div className="absolute bottom-2 right-2 w-7 h-7 border-b-2 border-r-2 border-accent-purple/30" />
                  <div className="relative z-10 flex items-center justify-center p-4">
                    <Image src="/images/products/visionpro-m500.png" alt="VisionPro M500 Advanced Benchtop SPI" width={300} height={340} className="object-contain h-[300px] sm:h-[460px] w-auto max-w-full rounded-lg" />
                  </div>
