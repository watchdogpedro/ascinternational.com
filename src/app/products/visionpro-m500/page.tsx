              ...
              <div className="relative">
                <div className="relative overflow-hidden rounded-2xl border border-accent-purple/30 bg-dark-bg mx-auto w-fit">
                  ...
                  <div className="relative z-10 flex items-center justify-center p-[18px]">
                    <Image src="/images/products/visionpro-m500.jpg" alt="VisionPro M500 Advanced Benchtop SPI" width={300} height={340} className="object-contain h-[300px] sm:h-[460px] w-auto max-w-full rounded-lg" />
                  </div>
