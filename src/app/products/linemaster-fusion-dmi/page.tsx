          ...
          <div className="relative container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div className="relative">
                <div className="relative overflow-hidden rounded-2xl border border-green-500/30 bg-dark-bg aspect-square">
                  ...
                  <div className="relative z-10 h-full flex items-center justify-center p-12">
                    <Image src="/images/products/linemaster-fusion-dmi.jpg" alt="LineMaster Fusion DMI Dual-Mode 3D SPI and AOI System" width={320} height={380} className="object-contain max-h-full w-auto rounded-lg" />
                  </div>
