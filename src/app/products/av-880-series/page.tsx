              ...
              <div className="relative">
                <div className="relative overflow-hidden rounded-2xl border border-accent-cyan/30 bg-dark-bg" style={{ height: "420px" }}>
                  ...
                  <div className="relative z-10 h-full flex items-center justify-center p-12">
                    <Image src="/images/products/av-880-series.png" alt="AV 880 Series Inline AOI System" width={320} height={380} className="object-contain max-h-full w-auto rounded-lg" />
                  </div>
