...
export const metadata: Metadata = {
  title: "CyberOptics SE Series | Pre-Owned Inline 3D SPI | ASC International",
              ...
              <div className="relative">
                <div className="relative overflow-hidden rounded-2xl border border-accent-cyan/30 bg-dark-bg" style={{ height: "420px" }}>
                  ...
                  <div className="relative z-10 h-full flex items-center justify-center p-8">
                    <Image src="/images/products/cyberoptics-se-series.png" alt="CyberOptics SE Series Inline 3D SPI System" width={320} height={380} className="object-contain max-h-full w-auto" />
                  </div>
