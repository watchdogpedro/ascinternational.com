              ...
              <div className="relative">
                <div className="relative overflow-hidden rounded-2xl border border-accent-cyan/30 bg-dark-bg aspect-square">
                  ...
                  <div className="relative z-10 h-full flex items-center justify-center p-12">
                    <Image src="/images/products/cyberoptics-se-series.png" alt="CyberOptics SE Series Inline 3D SPI System" width={320} height={380} className="object-contain max-h-full w-auto rounded-lg" />
                  </div>
