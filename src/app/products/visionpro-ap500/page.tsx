              ...
              <div className="relative">
                <div className="relative overflow-hidden rounded-2xl border border-accent-cyan/30 bg-dark-bg" style={{ height: "420px" }}>
                  ...
                  <div className="relative z-10 h-full flex items-center justify-center p-8">
                    <Image src="/images/products/visionpro-ap500.jpg" alt="VisionPro AP500 Offline 3D SPI System" width={380} height={320} className="object-contain max-h-full w-auto" />
                  </div>
