              ...
              <div className="relative">
                <div className="relative overflow-hidden rounded-2xl border border-green-500/30 bg-dark-bg aspect-square">
                  ...
                  <div className="relative z-10 h-full flex items-center justify-center p-12">
                    <Image src="/images/products/linemaster-dmi.jpg" alt="LineMaster DMI Dual Mode SPI AOI System" width={340} height={360} className="object-contain max-h-full w-auto rounded-lg" />
                  </div>
