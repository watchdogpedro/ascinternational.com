...
export const metadata: Metadata = {
  title: "LineMaster Falcon | Affordable Inline 2D-3D AOI | ASC International",
              ...
              <div className="relative">
                <div className="relative overflow-hidden rounded-2xl border border-accent-blue/30 bg-dark-bg" style={{ height: "420px" }}>
                  ...
                  <div className="relative z-10 h-full flex items-center justify-center p-8">
                    <Image src="/images/products/linemaster-falcon.jpg" alt="LineMaster Falcon Affordable Inline 2D-3D AOI" width={380} height={380} className="object-contain max-h-full w-auto" />
                  </div>
