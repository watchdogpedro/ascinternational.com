...
const datasheet = documentForProduct("mss-130-dvi");
      ...
      <main className="bg-dark-bg">
          ...
          <div className="relative container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div className="relative">
                <div className="relative overflow-hidden rounded-2xl border border-yellow-500/30 bg-dark-bg mx-auto w-fit">
                  ...
                  <div className="absolute top-1 left-1 w-7 h-7 border-t-2 border-l-2 border-yellow-500/60" />
                  <div className="absolute top-1 right-1 w-7 h-7 border-t-2 border-r-2 border-yellow-500/60" />
                  <div className="absolute bottom-1 left-1 w-7 h-7 border-b-2 border-l-2 border-yellow-500/30" />
                  <div className="absolute bottom-1 right-1 w-7 h-7 border-b-2 border-r-2 border-yellow-500/30" />
                  <div className="relative z-10 flex items-center justify-center p-[18px]">
                    <Image src="/images/products/mss-130-dvi.jpg" alt="MSS 130 DVI Digital Video Inspection Scope" width={360} height={380} className="object-contain h-[300px] sm:h-[460px] w-auto max-w-full rounded-lg" />
                  </div>
        ...
        <section className="py-16 bg-dark-secondary border-t border-white/10">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center max-w-2xl">
            ...
            <p className="text-gray-400 mb-6">The datasheet covers dimensions, throughput and measurement specifications. Lens and lighting options are quoted against your line.</p>
