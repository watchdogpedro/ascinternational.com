...
export const metadata: Metadata = {
  alternates: { canonical: '/products/linemaster-falcon-plus' },
  title: "LineMaster Falcon Plus | AOI + SPI",
  description: "Inline dual-mode system running 3D SPI and AOI in one pass. 12 MP color camera, dual laser height verification, RGBW-UV lighting, 20x20 inch board area.",
  keywords: ["LineMaster Falcon Plus", "inline AOI SPI", "dual mode AOI", "inline inspection system"],
};

const highlights = [
  "Inline dual mode: 3D SPI + AOI",
  "12 MP high-resolution color camera",
  "Dual laser height verification",
  "RGBW-UV LED lighting system",
  "Standard board area: 20\" × 20\"",
  "Extended option: up to 48\" × 20\"",
  "Very low false call rate",
  "Integrated SPC charts",
];

export default function LinemasterFalconPlus() {
  return (
    <>
      <Header />
      <main className="bg-dark-bg">
        ...
        <section className="py-16 lg:py-24 relative overflow-hidden">
          <div className="absolute inset-0" style={{ background: "radial-gradient(ellipse at 30% 50%, rgba(0,217,255,0.06) 0%, transparent 60%)" }} />
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div className="relative">
                <div className="relative overflow-hidden rounded-2xl border border-accent-cyan/30 bg-dark-bg" style={{ height: "420px" }}>
                  ...
                  <div className="relative z-10 h-full flex items-center justify-center p-8">
                    <Image src="/images/products/linemaster-falcon-plus.jpg" alt="LineMaster Falcon Plus Inline Dual Mode AOI SPI" width={380} height={380} className="object-contain max-h-full w-auto" />
                  </div>
              ...
              <div>
                <div className="flex flex-wrap gap-2 mb-4">
                  ...
                  <span className="bg-green-500/15 text-green-400 border border-green-500/30 text-xs font-semibold px-3 py-1 rounded-full">Dual Mode SPI + AOI</span>
                </div>
                <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">LineMaster Falcon Plus</h1>
                <p className="text-lg text-gray-300 mb-3 leading-relaxed">
                  Inline dual-mode inspection system combining 3D SPI technology and state-of-the-art AOI in one platform — validating both the solder printing process and component placement in a single pass.
                </p>
                <p className="text-gray-400 mb-8 leading-relaxed">
                  Equipped with a 12 MP high-resolution color camera, dual laser height verification, and RGBW-UV LED lighting, the LineMaster Falcon Plus detects absence, presence, polarity, OCR, solder defects, and lead quality with very low false call rates. Standard 20″ × 20″ board capacity with extended options up to 48″ × 20″.
                </p>
