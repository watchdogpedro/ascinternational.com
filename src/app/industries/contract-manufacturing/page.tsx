...
export const metadata: Metadata = {
  ...
  title: "Contract Manufacturing (EMS) Inspection",
  description: "Flexible, high-mix inspection for contract manufacturers and EMS providers. Fast changeovers, multi-standard compliance, and open architecture.",
