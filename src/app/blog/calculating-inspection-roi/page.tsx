...
export const metadata: Metadata = {
  ...
  title: "Calculating ROI for Inspection Equipment",
  description: "How to calculate return on investment for inspection systems. Quantify hard and soft costs, typical payback periods, and justify the purchase.",
